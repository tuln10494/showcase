...
import kotlinx.android.synthetic.main.list_item_full_horizontal_control.view.*

internal class ControlAdapterFullHorizontal : RecyclerView.Adapter<ControlAdapterFullHorizontal.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_item_full_horizontal_control, parent, false)
